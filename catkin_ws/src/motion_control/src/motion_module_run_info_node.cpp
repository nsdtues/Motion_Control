...
void sub_force_run_info_msg_callback(const motion_control::motion_run_info_msg& force_run_info_input)
{
...
void sub_pot_run_info_msg_callback(const motion_control::motion_run_info_msg& pot_run_info_input)
{
...
void sub_motor_run_info_msg_callback(const motion_control::motion_run_info_msg& motor_run_info_input)
{
